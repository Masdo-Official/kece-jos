...
const G = {
  ...
  sloganHero:
    "Website ini dibuat sepenuhnya dengan HTML, CSS, dan JavaScript Vanilla murni — dan ya, prosesnya dibantu AI. Bukan karena tidak bisa sendiri, tapi karena saya percaya bahwa kolaborasi antara manusia dan teknologi adalah cara paling relevan untuk berkarya di era ini.",
  ...
  namaSiswa: [
    ...
    },
    {
      ...
      namaAudio: null,
      fotoAudio: null,
      descAudio: "ggdjsdjs dhks fgskd gsdfsfsdf ssf dsiegufwiegf ws dsgidgs dfsdgfis sdgfsidfgi sudgfsi sf sifi sdfis gdisgrieriw  w",
